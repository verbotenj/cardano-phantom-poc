#!/usr/bin/env bash
# ==============================================================================
# LOCAL AUTOMATION: RUN COMPLETE CARDANO WALLET E2E POC SUITE
# ==============================================================================
# This script automates checking environment configurations, starting the local
# Gateway proxy, and executing both programmatic E2E proofs cleanly.
# ==============================================================================
...
echo -e "${GREEN}[*] Initializing E2E POC Execution Workspace...${NC}"
...
echo -e "${GREEN}[*] Local environment configuration verified.${NC}"
...
# 3. Boot Local Gateway Proxy in the background
...
# 4. Run E2E Wallet Lifecycle Proof
echo -e "\n${CYAN}======================================================================${NC}"
echo -e "${CYAN}[EXECUTION] Running Proof 1: E2E Programmatic Wallet Lifecycle${NC}"
echo -e "${CYAN}======================================================================${NC}"
node proofs/e2e_wallet_proof.js

# Allow 3 seconds for the indexer database to synchronize before running Proof 2
echo -e "\n${YELLOW}[*] Ledger Synchronization: Sleeping 3s to allow indexer to synchronize...${NC}"
sleep 3

# 5. Run E2E Loop State Transition Verification
echo -e "\n${CYAN}======================================================================${NC}"
echo -e "${CYAN}[EXECUTION] Running Proof 2: State Transition & Block Settlement Loop${NC}"
echo -e "${CYAN}======================================================================${NC}"
node proofs/e2e_loop_verify.js

echo -e "\n${GREEN}[+] All E2E Proof executions successfully completed!${NC}"
